...
/**
 * This class demonstrates database creation and dropping. It then shows how to
 * add indexes to the database and retrieve some information on the database
 * structures.
 *
...
public final class RunCommands {
    ...
    private static final Logger LOG = Logger.getLogger(RunCommands.class.getName());
    private final Properties properties = new Properties();
//    private WebElement container = null;

    public static void main(String[] args)  {
        LOG.fine("starting..");
        java.util.List<String> fdk = new ArrayList<>();
        String kf = "list";
        fdk.add(kf);
        new App().foo(fdk);
    }

    public void foo(final String... args) throws BaseXException {
        // Database context.
